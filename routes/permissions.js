...
router.group("/v1.0", (versionRouter) => {
  versionRouter.get(
    "/permissions",
    /*[authMiddleware.verifyToken, aclMiddleware.hasPermission('listView', 'permission-section')],*/ exceptionHandler(
  ...
  versionRouter.get(
    ...
    [
      ...
      aclMiddleware.hasPermission("dropDownList", "permission-section"),
    ],
    exceptionHandler(permissionsController.permissionsDDLList)
  );
