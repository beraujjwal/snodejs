...
router.group('/v1.0', (versionRouter) => {
  ...
  versionRouter.get('/resources', /*[authMiddleware.verifyToken, aclMiddleware.hasPermission('listView', 'resource-section')],*/ exceptionHandler(resourcesController.findAll));
